// const
const MAPBOX_TOKEN =
  'pk.eyJ1Ijoib3JkaW5hcnlzayIsImEiOiJja2h6bmthY20wMWxoMnpwZXI1ZzRmc2twIn0.VSZPcs6hX8jWFiN7vxxDMw';
...
const CHINESE_INFO_MESSAGE = (yearLength: number, year: string): string => {
  ...
  return `我是OrdinarySK，我用Keep 记录自己跑步 ${yearLength} 年了，下面列表展示的是${yearStr}的数据`;
};
